    ...
    <div className="min-h-screen bg-[#050a14] text-white flex flex-col">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled ? "bg-[#050a14]/95 backdrop-blur-md border-b border-white/10 shadow-2xl" : "bg-transparent"
        }`}
      >
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <Link
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                location.pathname === "/" ? "text-cyan-400" : "text-white/70 hover:text-white"
              }`}
            >
              Home
            </Link>
            ...
            <div className="relative" onMouseLeave={() => setProductsOpen(false)}>
              <button
                ...
                className={`flex items-center gap-1 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                  location.pathname.startsWith("/products") ? "text-cyan-400" : "text-white/70 hover:text-white"
                }`}
              >
            ...
            {navLinks.slice(1).map((link) => (
              <Link
                ...
                to={link.href}
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                  location.pathname === link.href ? "text-cyan-400" : "text-white/70 hover:text-white"
                }`}
              >
                {link.label}
              </Link>
      ...
      <footer className="bg-[#030710] border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-white font-black text-lg leading-none">Mobilise</div>
                  <div className="text-cyan-400 text-[10px] font-semibold tracking-[0.2em] uppercase">For Robotics</div>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-2 text-white/50 text-sm">
                  ...
                  <a href="mailto:info@mobilise.in" className="hover:text-cyan-400 transition-colors">info@mobilise.in</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-white/30 text-sm">© 2026 Mobilise for Robotics. Authorized KEENON Robotics Partner in India.</p>
